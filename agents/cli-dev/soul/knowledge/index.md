...
* [lessons/canonical-worktree-verification.md](lessons/canonical-worktree-verification.md) - Git canonicalizes symlinked worktree paths, so rollback checks must capture the work realpath before removal and compare it to exact NUL-delimited worktree records.
