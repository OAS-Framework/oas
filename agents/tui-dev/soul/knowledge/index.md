...
* [Desktop shell view integration lessons](desktop-shell-view-integration-lessons.md) — Ported panel views rely on singleton modules, key-deduped tabs, context-owning picker tabs, .mjs loader naming, workspace-aware API pinning, exactly-once Fetch body serialization, and inline degradation when older shared servers lack endpoints.
