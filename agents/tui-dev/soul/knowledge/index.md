...
* [Desktop shell view integration lessons](desktop-shell-view-integration-lessons.md) — Ported panel views rely on singleton modules, key-deduped tabs, .mjs loader naming, workspace-aware API pinning, and inline degradation when older shared servers lack endpoints.
