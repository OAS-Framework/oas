---
type: Lesson
title: Concurrent harvests of one soul: union pure additions, route editorial conflicts
description: When parallel instances of one soul harvest into separate branches, union append-only logs and pure-addition index/link conflicts, but route duplicate concepts or competing rewrites to an owner and verify cross-links on the merged tree.
tags: [harvest, integration, coordination, okf]
timestamp: 2026-07-23T00:30:00Z
---

# Lesson

During feature/desktop-app, three webpanel-dev instances ran in parallel and harvested notes into the same soul (`agents/webpanel-dev/soul/knowledge/`). When their branches were integrated, the soul knowledge bundle repeatedly conflicted.
