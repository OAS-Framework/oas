...
- OAS-Framework/oas-authoring PR #1 round 4 dedicated capability-root v2 release: APPROVED/HOLD 2026-08-20 at exact head `3ff0025`; single-backslash Windows absolute-path fix and all gates pass, fresh reviewer/co-gate both pending (see delivery-log).
