...
- PR #44 Desktop split/sidebar UI buttons + active-tab split seeding + split-aligned tab strip: RETURNED round 2 on 2026-07-26 at exact head `defa48d` for mergeability/current-main only; product/correctness/security and all local/CI/installer gates passed, waiting for current-main refresh (see delivery-log).
