...
One public release, built from one tag: `@oas-framework/oas@0.18.4`,
`@oas-framework/pi@0.18.4`, and **OAS Desktop 0.18.4** (attached to this
GitHub Release).
...
```bash
npm install -g @oas-framework/oas@0.18.4
```
