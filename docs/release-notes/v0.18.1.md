...
One public release, built from one tag: `@oas-framework/oas@0.18.1`,
`@oas-framework/pi@0.18.1`, and **OAS Desktop 0.18.1** (attached to this
GitHub Release).
...
**Windows and Linux arm64 are not supported in 0.18.1.**

The 0.18.1 installers are **unsigned and not notarized**. On macOS, open via
...
- `oas version [--json]` — the Desktop API v1 probe:
  `{"schemaVersion":1,"name":"@oas-framework/oas","version":"0.18.1","desktopApi":1}`.
