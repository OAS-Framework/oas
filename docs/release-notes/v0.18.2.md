...
One public release, built from one tag: `@oas-framework/oas@0.18.2`,
`@oas-framework/pi@0.18.2`, and **OAS Desktop 0.18.2** (attached to this
GitHub Release).
...
- `oas version [--json]` — the Desktop API v1 probe:
  `{"schemaVersion":1,"name":"@oas-framework/oas","version":"0.18.2","desktopApi":1}`.
