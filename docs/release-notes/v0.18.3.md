...
One public release, built from one tag: `@oas-framework/oas@0.18.3`,
`@oas-framework/pi@0.18.3`, and **OAS Desktop 0.18.3** (attached to this
GitHub Release).
...
```bash
npm install -g @oas-framework/oas@0.18.3
```

The pi bridge `@oas-framework/pi` publishes in lockstep. Desktop downloads
