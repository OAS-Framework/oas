...
One public release, built from one tag: `@oas-framework/oas@0.18.5`,
`@oas-framework/pi@0.18.5`, and **OAS Desktop 0.18.5** (attached to this
GitHub Release).
...
```bash
npm install -g @oas-framework/oas@0.18.5
```
