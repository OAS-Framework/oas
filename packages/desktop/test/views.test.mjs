...
/* NOTE (merge of origin/main at v0.18.4): the Instances STAGE now uses
   main's repo→family grouping with sorts/collapse (feature/desktop-ux-fixes,
   reviewed on main). The agent-relations CLUSTER visualization lives in the
   permanent sidebar (shell.mjs, anonymous separators) and the Active
   overview (views/clusters.mjs) — the earlier cluster-grouped roster and its
   anonymous-group-semantics test were superseded by main's stage design. */
