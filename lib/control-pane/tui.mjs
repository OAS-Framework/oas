...
const RESET = `${ESC}0m`;
const C = {
  ink: `${ESC}38;2;226;231;245m`, muted: `${ESC}38;2;110;118;144m`, faint: `${ESC}38;2;66;73;96m`,
  cyan: `${ESC}38;2;77;208;225m`, violet: `${ESC}38;2;173;128;255m`, green: `${ESC}38;2;94;234;156m`,
  amber: `${ESC}38;2;250;193;92m`, red: `${ESC}38;2;255;107;129m`,
  guide: `${ESC}38;2;86;98;140m`,
  panel: `${ESC}48;2;18;20;30m`, card: `${ESC}48;2;24;27;40m`, selected: `${ESC}48;2;33;38;58m`,
  bar: `${ESC}48;2;13;15;23m`,
  bold: `${ESC}1m`, dim: `${ESC}2m`,
};

// Per-soul identity palette — the soul owns a color; the color IS the badge.
const SOUL_PALETTE = [
  { bg: `${ESC}48;2;77;208;225m`, fg: `${ESC}38;2;77;208;225m` },   // cyan
  { bg: `${ESC}48;2;173;128;255m`, fg: `${ESC}38;2;173;128;255m` }, // violet
  { bg: `${ESC}48;2;94;234;156m`, fg: `${ESC}38;2;94;234;156m` },   // green
  { bg: `${ESC}48;2;250;193;92m`, fg: `${ESC}38;2;250;193;92m` },   // amber
  { bg: `${ESC}48;2;255;121;198m`, fg: `${ESC}38;2;255;121;198m` }, // pink
  { bg: `${ESC}48;2;120;170;255m`, fg: `${ESC}38;2;120;170;255m` }, // blue
];
const BADGE_TEXT = `${ESC}38;2;12;14;22m`;
...
function branchChip(git, active) {
  ...
  const label = feature
    ? paint(` ${git.branch} `, `${ESC}48;2;64;46;96m`, `${ESC}38;2;204;170;255m`, C.bold)
...
function buildCard(row, ctx) {
  ...
  const meta = paint([roleName, relativeAge(instance.createdAt)].filter(Boolean).join(" · "), C.faint);
