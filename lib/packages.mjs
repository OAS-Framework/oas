...
import {
  ...
  runtimePackageInstalled, runtimePackageStatus, safeRuntimePackageSpec, validateConfigShape,
} from "./core.mjs";
...
export { packageSpecIdentity, RUNTIME_PACKAGE_MANAGERS, runtimePackageInstalled, runtimePackageStatus, safeRuntimePackageSpec };
